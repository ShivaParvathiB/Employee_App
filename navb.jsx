        ...
        {modalForm && <Modal isOpen>
            ...
            <ModalBody>
                ...
                <form  type="done" onSubmit={onChangeSubmit}>
                    ...
                    <label>EmpId :</label>
                    <input type="text" value={empId} placeholder="Emp Id" onChange={(e)=>{setEmpId(e.target.value)}}/> <br/>
                    <label>Department :</label>
                    <input type="text" value={dep} placeholder="Department" onChange={(e)=>{setDep(e.target.value)}}/> <br/> 
